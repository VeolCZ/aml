...
| :------------- | :------------- | :------------------------------------------------------------------------------------------------------------------- |
| `class_id`     | `integer`      | The predicted class ID. This integer represents the classified category (see Bird Class ID to Name Mapping section). |
| `bounding_box` | `array<float>` | Predicted bounding box coordinates [x\_min, y\_min, x\_max, y\_max] scaled to the [0-1] range.                       |
